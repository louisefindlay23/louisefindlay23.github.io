...
If you need a helping hand on either of those areas, check out my [Getting to Grips with Databases guide](../getting-to-grips-with-databases-part1) which will get you started and later expand into using EJS.