...
$(document).ready(function () {
    ...
    $("#test2, #test3, #test4, #test5, #test6").hide();
    ...
    $(".slide1").click(function () {
        $("#test2, #test3, #test4, #test5, #test6").hide();
        $("#test1").show();
        $(".dots .slide2, .dots .slide3, .dots .slide4, .dots .slide5, .dots .slide6").removeClass("orange");
    ...
    $(".slide2").click(function () {
        $("#test1, #test3, #test4, #test5, #test6").hide();
        $("#test2").show();
        $(".dots .slide1, .dots .slide3, .dots .slide4, .dots .slide5, .dots .slide6").removeClass("orange");
        $(".dots .slide2").addClass("orange");
        $(".fa-chevron-left, .fa-chevron-right").removeClass("hidden");
    });

    $(".slide3").click(function () {
        $("#test1, #test2, #test4, #test5, #test6").hide();
        $("#test3").show();
        $(".dots .slide1, .dots .slide2, .dots .slide4, .dots .slide5, .dots .slide6").removeClass("orange");
        $(".dots .slide3").addClass("orange");
        $(".fa-chevron-left, .fa-chevron-right").removeClass("hidden");
    });

    $(".slide4").click(function () {
        $("#test1, #test2, #test3, #test5, #test6").hide();
        $("#test4").show();
        $(".dots .slide1, .dots .slide2, .dots .slide3, .dots .slide5, .dots .slide6").removeClass("orange");
        $(".dots .slide4").addClass("orange");
        $(".fa-chevron-left, .fa-chevron-right").removeClass("hidden");
    });

    $(".slide5").click(function () {
        $("#test1, #test2, #test3, #test4, #test6").hide();
        $("#test5").show();
        $(".dots .slide1, .dots .slide2, .dots .slide3, .dots .slide4, .dots .slide6").removeClass("orange");
        $(".dots .slide5").addClass("orange");
        $(".fa-chevron-left, .fa-chevron-right").removeClass("hidden");
    });

    $(".slide6").click(function () {
        $("#test1, #test2, #test3, #test4, #test5").hide();
        $("#test6").show();
        $(".dots .slide1, .dots .slide2, .dots .slide3, .dots .slide4, .dots .slide5").removeClass("orange");
        $(".dots .slide6").addClass("orange");
