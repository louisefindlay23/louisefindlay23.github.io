...
$(document).ready(function() {
    ...
    $("#silvernotegrey.testimonial, .bbc.testimonial, .dragon.testimonial, #gold.testimonial, #julie.testimonial, #sn-test2, #bbc-test2, #bbc-test3, #dreamless-test2, #dreamless-test3").hide();
