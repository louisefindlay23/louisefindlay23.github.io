...
$(document).ready(function () {
    ...
    $(".webslide1").click(function () {
        ...
        $(".bbc.testimonial, #silvernotegrey.testimonial, .arteriale.testimonial").hide();
        $(".dots .webslide2, .dots .webslide3, .dots .webslide4").removeClass("orange");
    ...
    $(".webslide2").click(function () {
        ...
        $(".nescol.testimonial, .bbc.testimonial, .arteriale.testimonial").hide();
        $("#silvernotegrey.testimonial").show();
        $(".dots .webslide1, .dots .webslide3, .dots .webslide4").removeClass("orange");
    ...
    $(".webslide3").click(function () {
        ...
        $(".nescol.testimonial, #silvernotegrey.testimonial, .arteriale.testimonial").hide();
        $(".bbc.testimonial").show();
        $(".dots .webslide1, .dots .webslide2, .dots .webslide4").removeClass("orange");
        $(".dots .webslide3").addClass("orange");
        $(".fa-chevron-left, .fa-chevron-right").removeClass("hidden");
    });

    $(".webslide4").click(function () {

        $(".nescol.testimonial, #silvernotegrey.testimonial, .bbc.testimonial").hide();
        $(".arteriale.testimonial").show();
        $(".dots .webslide1, .dots .webslide2, .dots .webslide3").removeClass("orange");
        $(".dots .webslide4").addClass("orange");
